            ...
            seq.addCommands(
                ...
                Commands.parallel(
                    ...
                    Commands.sequence(
                        ...
                        new GoToCmdDirect(manipulator_, target_elev_pos_, Centimeters.of(3.0), MetersPerSecond.of(500.0), 
                                                        ManipulatorConstants.Arm.Positions.kKickbackAngle, Degrees.of(3.0), DegreesPerSecond.of(10.0))
                    )
                )) ;
        }
        else {
