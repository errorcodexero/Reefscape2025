...
public class CommandConstants {
    public static class ReefDrive {
        public static final LinearVelocity kMaxDriveVelocity = MetersPerSecond.of(2.5) ;
        public static final LinearAcceleration kMaxDriveAcceleration = MetersPerSecondPerSecond.of(2.5) ;
    }
