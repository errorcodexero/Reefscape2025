package frc.robot.commands.robot.scorereef;
...
public class ScoreReefAlgaeCmd extends SequentialCommandGroup {
    ...
    public ScoreReefAlgaeCmd(BrainSubsystem b, ManipulatorSubsystem m, GrabberSubsystem g) {
        setName("ScoreReefAlgaeCmd") ;
        addCommands(
            new GoToCmd(m, ElevatorScoreHeight, ArmScoreAngle),
            new DepositAlgaeCmd(g),
            new SetHoldingCmd(b, GamePiece.NONE),
