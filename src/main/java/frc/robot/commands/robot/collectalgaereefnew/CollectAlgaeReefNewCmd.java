package frc.robot.commands.robot.collectalgaereefnew;
...
public class CollectAlgaeReefNewCmd extends XeroSequenceCmd {
    ...
    public CollectAlgaeReefNewCmd(BrainSubsystem brain, Drive db, ManipulatorSubsystem manipulator, GrabberSubsystem grabber, ReefLevel height) {
        this(brain, db, manipulator, grabber, height, true, false) ;
    }

    public CollectAlgaeReefNewCmd(BrainSubsystem brain, Drive db, ManipulatorSubsystem manipulator, GrabberSubsystem grabber, ReefLevel height, boolean driveto, boolean skipfirst) {
    ...
    public void initSequence(SequentialCommandGroup seq) {
        ...
        if (driveto_) {
            ...
            seq.addCommands(new CollectAlgaeCmd(grabber_)) ;
        }
