...
public class OIIOHID implements OIIO {
    ...
    public void updateInputs(OIIosInputs inputs) {
        if (hid_ != null) {
            ...
            inputs.algae_reef_keep = hid_.getRawButton(OIConstants.Buttons.kAlgaeReefKeep) ;
            inputs.algae_reef_eject = hid_.getRawButton(OIConstants.Buttons.kAlgaeReefEject) ;
            ...
            inputs.algae_net = hid_.getRawButton(OIConstants.Buttons.kAlgaeNet) ;
        }
