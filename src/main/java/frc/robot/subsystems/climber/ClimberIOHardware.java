...
public class ClimberIOHardware implements ClimberIO {
    ...
    public ClimberIOHardware() {
        ...
        TalonFXFactory.checkError(ClimberConstants.ClimberArm.kMotorCANID, "climber apply pid values", () -> climber_motor_.getConfigurator().apply(climber_pids)) ;
        ...
        TalonFXFactory.checkError(ClimberConstants.ClimberArm.kMotorCANID, "climber apply motion magic values", () -> climber_motor_.getConfigurator().apply(climberMotionMagicConfigs)) ;
    }
